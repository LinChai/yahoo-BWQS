...
do
    ...
    do
        ...
        #make
        echo target/"BWQS"$LEAF"bit_full_optm_yahoo_"$D"_"$S -ensemble ../fast_rank/yahoo/tree-ensemble-file_20000_$LEAF -instances ../fast_rank/yahoo/100k.txt -maxLeaves $LEAF
